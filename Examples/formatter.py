...
# Load the JSON file
with open('/Users/marcovinciguerra/github/scrapegraphai-ai-copilot/Examples/anthropic_ config.json', 'r') as f:
    data = json.load(f)
...
for obj in data:
    ...
    script_file_path = '/Users/marcovinciguerra/github/scrapegraphai-ai-copilot/Examples/anthropic/' + obj['filename']
